package com.apps.Mounir.FireChatHelper;
...
public class ReferenceUrl {
    ...
    public static final String FIREBASE_CHAT_URL="https://intense-torch-1332.firebaseio.com/chat"; //Your app main firebase url
